...
const DegreeList = ({ selectedDegree }) => {
    ...
    const handleConcentrationSubmit = () => {
        if (selectedDegree) {
            fetch(`https://student-dasboard.onrender.com/graduation/concentration/${selectedDegree._id}`, {
            method: "POST",
            headers: {
    ...
    const handleRequirementSubmit = () => {
        if (selectedConcentration && selectedDegree) {
            fetch(`https://student-dasboard.onrender.com/graduation/requirement/${selectedDegree._id}/${selectedConcentration}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const handleCourseSubmit = () => {
        if (selectedDegree && selectedConcentration && selectedRequirement) {
            fetch(`https://student-dasboard.onrender.com/graduation/course/${selectedDegree._id}/${selectedConcentration}/${selectedRequirement}`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
