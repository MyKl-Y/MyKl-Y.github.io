...
const Account = () => {
    ...
    const fetchUserData = useCallback(() => {
        ...
        fetch(`https://student-dashboard.onrender.com:5050/auth/account/${userData.name}`)
    ...
    useEffect(() => {
        ...
        fetch(`https://student-dashboard.onrender.com:5050/graduation/degree/user/${userData.name}`)
            ...
            .catch((error) => console.error(error));
        fetch(`https://student-dashboard.onrender.com:5050/courses/user/${userData.name}`)
            .then((res) => res.json())
            .then((data) => {
                setCourses(data);
            })
    ...
    async function handleEditAccount(e) {
        ...
        if (isLoggedIn){
            ...
            await fetch(`https://student-dashboard.onrender.com:5050/auth/account/${userData.name}`, {
                method: "PATCH",
                headers: {
