...
export default function EditTask() {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            const response = await fetch(`https://student-dashboard.onrender.com:5050/task/${params.id.toString()}`);
    ...
    async function onSubmit(e) {
        ...
        await fetch(`https://student-dashboard.onrender.com:5050/task/${params.id}`, {
            method: "PATCH",
