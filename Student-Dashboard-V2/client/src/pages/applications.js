...
export default function Applications() {
    ...
    useEffect(() => {
        ...
        async function getJobs() {
            const response = await fetch(`https://student-dashboard.onrender.com:5050/jobs/user/${userData.name}`);
    ...
    async function deleteJob(id) {
        await fetch(`https://student-dashboard.onrender.com:5050/jobs/${id}`, {
            method: "DELETE",
            headers: {
