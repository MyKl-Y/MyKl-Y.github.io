<template>
  <div class="about">
    ...
    <ul>
      <li>
        <b>Exploring New Technologies</b>: From software engineering to game development, I am constantly driven to
        understand and innovate in the fields of machine learning, cybersecurity, and beyond.
      </li>
      <li>
        <b>Engaging with Music and Audio</b>: As a lover of music and high-fidelity audio, I seek to blend my technical 
        skills with my artistic interests, whether it's through creating or simply appreciating sound.
      </li>
      <li>
        <b>Savoring Every Sip</b>: My interest in coffee goes beyond a morning routine—it's about the experience, 
